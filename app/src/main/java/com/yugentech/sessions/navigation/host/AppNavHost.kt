...
fun AppNavHost(
    ...
    val startDestination = remember {
        when {
            ...
            authState.isUserLoggedIn && authState.userId != null -> Screen.Main.route
        ...
        if (!authState.isLoading) {
            ...
            if (showOnboarding) {
                ...
                if (currentRoute != Screen.SignIn.route && currentRoute != Screen.SignUp.route) {
                    val comingFromOnboarding = currentRoute == Screen.Onboarding.route
    ...
    NavHost(
        ...
        composable(Screen.Insights.route) { it ->
