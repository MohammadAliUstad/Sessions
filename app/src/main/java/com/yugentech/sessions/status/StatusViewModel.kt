...
import com.yugentech.sessions.status.StatusCleanupService
...
class StatusViewModel(
    ...
    fun sessionTrackingService(context: Context, userId: String, isStudying: Boolean) {
        ...
        val serviceIntent = Intent(context, StatusCleanupService::class.java).apply {
    ...
    fun cleanupOnAppExit(context: Context, userId: String) {
        ...
        val serviceIntent = Intent(context, StatusCleanupService::class.java)
        context.stopService(serviceIntent)
